...
function drawInitial(){
    ...
    function mouseOver(d, i){
        ...
        d3.select('#tooltip')
            ...
            .attr('xlink:href', '/Users/geetkalra/Desktop/Assignment 4/cat.png')
            .attr('width', 100)
            .attr('height', 100)
            .attr('opacity', 0.5)
    ...
    .attr('xlink:href', '/Users/geetkalra/Desktop/Assignment 4/data/plot1.png')
    .attr('width', 500)
    .attr('height', 500)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot2')
    .attr('xlink:href', '/Users/geetkalra/Desktop/Assignment 4/data/plot2.png')
    .attr('width', 500)
    .attr('height', 500)
    .attr('opacity', 0)

    svg.append('g').append('image').attr('class', 'plot3')
    .attr('xlink:href', '/Users/geetkalra/Desktop/Assignment 4/data/plot3.png')
    .attr('width', 500)
    .attr('height', 500)
    .attr('opacity', 0)
}
...
function plottype(plotType){
    ...
    if (plotType == "plot1") {
        svg.select('.plot1').attr('opacity', 1)
        svg.select('.plot2').attr('opacity', 0)
        svg.select('.plot3').attr('opacity', 0)
    }
    if (plotType == "plot2"){
        svg.select('.plot1').attr('opacity', 0)
        svg.select('.plot2').attr('opacity', 1)
        svg.select('.plot3').attr('opacity', 0)
    }
    if (plotType == "plot3"){
        svg.select('.plot1').attr('opacity', 0)
        svg.select('.plot2').attr('opacity', 0)
        svg.select('.plot3').attr('opacity', 1)
    }
}   
...
//    let pcube = d3.selectAll('.catsphish').append('svg') 
    
//    let kitty = d3.select('#billi').select('svg')
//    svg.append('image')
//     .attr('xlink:href', '/Users/geetkalra/Desktop/Assignment 4/cat.png')
//     .attr('width', 200)
//     .attr('height', 200)
